...
public class DateUtils {
  ...
  /**
   * <br> 第一个日期减去第二个日期后得到的天数</br> <br> 如果减去的后的天数有不满足一整天的，则不计入天数内</br>
   *
   * @param date 被减日期
   * @param day 减去的日期
   * @return 返回减去后的天数
  ...
  /**
   * 根据传入的两个日期获得日期的时间差<br/> 如果距离时间小于1分钟则返回的时间为秒<br/> 如果距离时间小于1小时则返回的时间为分<br/>
   * 如果距离时间小于1天则返回的时间为小时<br/> 其它则去天数
   *
   * @author fengyuan
   */

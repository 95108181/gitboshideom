...
<link href="../module/css/chengGongstyle.css" media="screen, projection" rel="stylesheet" type="text/css">

<script type="text/javascript" src="../module/js/jquery-1.8.2.min.js"></script>
...
<div id="wrap" class="clearfix">
	...
	<div id="smash_page">
		<h2>程序执行成功啦(#^.^#)..</h2>
		<h2><a href="/user/home" />点击返回主界面</h2>
	</div>

	<div id="smash" style="bottom: -135px;">
		<div class="skull" style="cursor: pointer;">
			<div class="eyes">
				<img alt="Eyes01" class="pupils" src="../module/images/eyes.png" style="left: 29px; top: 6px;">
				<img alt="Hilites02" class="hilites" src="../module/images/hilites.png" style="left: 20px; top: 10px;">
			</div>
			<img alt="Face04" class="face" src="../module/images/face.png">
		</div>
	</div>
</div> <!-- /#wrap -->
